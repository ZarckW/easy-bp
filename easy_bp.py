...
import numpy as np
import h5py
Num=50#迭代次数 Number of iterations
#载入数据（猫/非猫） Loading the data (cat/non-cat)
...
y=Tr_y.long()#209*1
#画原始数据 draw the original picture
plt.ion() 
plt.figure()
for t in range(50):
  plt.subplot(8,8,t+1)
...
#训练和测试网络 train and test the network
